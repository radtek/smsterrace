...
namespace hz.sms.DBUtility
{
    ...
    public abstract class DbHelperOleDb
    {
        ...
        public static string connectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source="+Application.StartupPath+"\\db.mdb;Persist Security Info=True"; 
        ...
        public static DataTable GetTable(string SQLString, params OleDbParameter[] cmdParms)
        {
            using (OleDbConnection connection = new OleDbConnection(connectionString))
            {
                OleDbCommand cmd = new OleDbCommand();
