...
namespace hz.sms.DBUtility
{
    ...
    public abstract class DbHelperSQL
    {
        ...
        public static string connectionString = ConfigurationManager.ConnectionStrings["SmsConnectionString"].ConnectionString;     		
        public DbHelperSQL()
        {            
        }
       ...
       */
        ...
        public static DataTable GetTable(string SQLString, params SqlParameter[] cmdParms)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                SqlCommand cmd = new SqlCommand();
        ...
        public static DataTable GetTable(string SQLString, List<SqlParameter> cmdParms)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                SqlCommand cmd = new SqlCommand();
