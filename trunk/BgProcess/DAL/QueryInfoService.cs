   ...
   public class QueryInfoService
    {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(hz.sms.Model.QueryInfo model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 更新一条数据
        /// </summary>
        public void Update(hz.sms.Model.QueryInfo model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 得到一个对象实体
        /// </summary>
        public hz.sms.Model.QueryInfo GetModel(decimal seqId)
        {
            ...
            hz.sms.Model.QueryInfo model = new hz.sms.Model.QueryInfo();
